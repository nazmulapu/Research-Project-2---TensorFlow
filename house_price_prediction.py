...
#normalize the data to prevent under/overflows

def normalize(array):
    return (array - array.mean()) / array.std()

#define the number of training samples, 0.7 = 70%. we can take first 70% as the value was randomized.abs
...
#set up the Tensorflow placeholders that get updated as we descend down the gradiant
...
#Optimizer learing rates. The size of the steps down the gradient
learning_rate = 0.1
...
#Lanunch the graph in the session 
